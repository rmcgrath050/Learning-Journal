...
I applied the principles of a blue-green deployment by maintaining the existing reporting environment while configuring and validating the new server. This allowed the new configuration to be tested against the existing process before the migration was completed, reducing the risk of disruption to reporting
